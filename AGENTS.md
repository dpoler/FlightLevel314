...
**Current product/runtime snapshot (2026-09-23):**
[`docs/agent-knowledge-2026-09-23.md`](docs/agent-knowledge-2026-09-23.md).
Treat both as point-in-time — verify against current code before relying on
