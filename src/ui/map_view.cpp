...
static void canvas_draw_cb(lv_event_t *e) {
    ...
    weather_draw(layer);
    {
        lv_color_t fc = airport_glyph_color();
        lv_opa_t fo = airport_glyph_label_opa();
        fixes_draw(layer, map_proj_to_screen, fc, fo);
    }
#elif HAS_STATIC_MAP
