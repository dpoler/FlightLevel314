...
// Vendored verbatim (2026-07-25) from Espressif's published esp-iot-solution
// component "esp_lcd_ek79007" (components/display/lcd/esp_lcd_ek79007,
// package version 2.0.2~1), the same driver used on Espressif's own
// reference ESP32-P4-Function-EV-Board. This project pulls hardware driver
// files in by hand via a plain PlatformIO -I include (see hal/esp_lcd_jd9165.*
// for the existing precedent), not through ESP-IDF's component manager, so
// the version macros below (normally template-generated from
// idf_component.yml's version field at component-manager fetch time) are
